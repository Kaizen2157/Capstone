...
$query = "SELECT r.slot_number, r.start_date, r.start_time, r.duration_hours, r.total_cost, r.status, r.created_at 
          FROM reservations r 
          WHERE r.user_id = ? 
...
while ($row = $result->fetch_assoc()) {
    ...
    $row['total_cost'] = number_format($row['total_cost'], 2); // Formatting price to two decimals
